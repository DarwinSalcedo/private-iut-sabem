...
class Postulados extends CActiveRecord
{
	...
	{
		return array(
			'id_postulados' => 'Identificacion del Postulado',
			'id_conf_asc_fecha' => 'Configuracion de fecha Ascenso',
			'Cedula' => 'Cedula',
			'fecha_postulacion' => 'Fecha Postulacion',
			'hora_postulacion' => 'Hora Postulacion',
			'cedula_fun_recepcion' => 'Cedula Funcionario de Recepcion',
			'des_datos_receptor' => 'Datos del Receptor',
