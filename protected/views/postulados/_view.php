...
<div class="view">
	...
	<?php #echo CHtml::encode($data->getAttributeLabel('id_postulados')); ?>
	<?php #echo CHtml::link(CHtml::encode($data->id_postulados), array('view', 'id'=>$data->id_postulados)); ?>
	

	<?php #echo CHtml::encode($data->getAttributeLabel('id_conf_asc_fecha')); ?>
	<?php #echo CHtml::encode($data->id_conf_asc_fecha); ?>
	

	<b><?php echo CHtml::encode($data->getAttributeLabel('Cedula')); ?>:</b>
	<?php #echo CHtml::encode($data->Cedula); ?>
	<?php echo CHtml::link(CHtml::encode($data->Cedula), array('view', 'id'=>$data->id_postulados)); ?>
	<br />
